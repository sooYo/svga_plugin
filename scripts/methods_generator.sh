...
DART_SOURCE="${DART_SOURCE_DIR}methods.dart"
KOTLIN_SOURCE="${KOTLIN_SOURCE_DIR}Methods.kt"
OBJC_SOURCE="${OBJC_SOURCE_DIR}Methods"

echo "Generating methods declaration files..."

if [ ! -d "$DART_SOURCE_DIR" ]; then
  mkdir -p $DART_SOURCE_DIR
  chmod 777 ../lib/src/constants ../lib/src ../lib
fi

if [ ! -d "$OBJC_SOURCE_DIR" ]; then
  mkdir -p $OBJC_SOURCE_DIR
  chmod 777 ../ios/Classes/Constants ../ios/Classes ../ios
fi

if [ ! -d "$KOTLIN_SOURCE_DIR" ]; then
  mkdir -p $KOTLIN_SOURCE_DIR
fi
