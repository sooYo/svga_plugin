...
KOTLIN_SOURCE_DIR='../android/src/main/kotlin/com/svga/plugin/svga_plugin/constants/'
OBJC_SOURCE_DIR='../ios/Classes/Constants/'

ERR_CODE_DEFINES='../material/code_list'
DART_SOURCE="${DART_SOURCE_DIR}status_codes.dart"
KOTLIN_SOURCE="${KOTLIN_SOURCE_DIR}StatusCodes.kt"
OBJC_SOURCE="${OBJC_SOURCE_DIR}StatusCodes.h"
...
function genKotlinTemplateFile() {
  ...
  {
    printf "package com.svga.plugin.svga_plugin.constants\n\n"
    printf "enum class StatusCodes(val code: Int) {\n"
    printf "}"
  } >>"$KOTLIN_SOURCE"
}
...
function genObjcTemplateFile() {
...

  {
    ...
    printf "typedef NS_ENUM(NSInteger, StatusCodes) {\n"
    printf "};"
  } >>"$OBJC_SOURCE"
}
